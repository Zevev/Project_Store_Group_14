<template id="item-create" @item-submitted="createItem">
    <div class="form-style">
        <h2>Create new item in the {{storeName}}</h2>
        <form class="create" @submit="checkForm" :action=`/api/stores/${storeName}/createitem` method="post">
    ...
    Vue.component("item-create", {
        ...
        methods:{
            checkForm:function(e) {
                ...
                if(this.storeName && this.name && this.itemType && this.itemPrice) return true;
                this.errors = [];
                if (!this.name) this.errors.push("Name required");
                if (!this.itemType) this.errors.push("Type required");
